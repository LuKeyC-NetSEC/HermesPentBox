---
name: hacker-csrf-cross-site-request-forgery
description: "CSRF testing playbook. Use when reviewing state-changing web flows, anti-CSRF defenses, SameSite behavior, JSON CSRF, login CSRF, and OAuth state handling."
metadata:
  hermes:
    tags: [misc, "redteam", "offensive"]
    related_skills: ["hacker-csrf-cross-site-request-forgery", "hacker-hack", "hacker-insecure-source-code-management", "hacker-network-protocol-attacks"]
---
