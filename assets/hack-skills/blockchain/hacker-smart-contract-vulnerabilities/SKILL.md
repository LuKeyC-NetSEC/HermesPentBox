---
name: hacker-smart-contract-vulnerabilities
...
metadata:
  hermes:
    tags: [blockchain, "redteam", "offensive"]
    related_skills: ["hacker-defi-attack-patterns", "hacker-smart-contract-vulnerabilities"]
---
...
Also load [SOLIDITY_VULN_PATTERNS.md](references/SOLIDITY_VULN_PATTERNS.md) when you need:
