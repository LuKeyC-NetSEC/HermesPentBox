---
name: hacker-llm-prompt-injection
...
metadata:
  hermes:
    tags: [ai, "redteam", "offensive"]
    related_skills: ["hacker-ai-ml-security", "hacker-llm-prompt-injection"]
---
...
Also load [JAILBREAK_PATTERNS.md](references/JAILBREAK_PATTERNS.md) when you need:
...
Effectiveness varies by model and version. See [JAILBREAK_PATTERNS.md](references/JAILBREAK_PATTERNS.md) for comprehensive catalog.
