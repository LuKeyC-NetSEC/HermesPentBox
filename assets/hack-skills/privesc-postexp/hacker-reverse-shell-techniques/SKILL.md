---
name: hacker-reverse-shell-techniques
description: "Reverse shell techniques playbook. Use when establishing remote shells including language one-liners, encrypted shells (OpenSSL/socat/ncat), web shells, PTY upgrades, file transfer methods, PowerShell shells, and Windows payload generation."
metadata:
  hermes:
    tags: [privesc-postexp, "redteam", "offensive"]
    related_skills: ["hacker-linux-lateral-movement", "hacker-linux-privilege-escalation", "hacker-linux-security-bypass", "hacker-macos-security-bypass", "hacker-reverse-shell-techniques", "hacker-tunneling-and-pivoting", "hacker-windows-av-evasion", "hacker-windows-lateral-movement", "hacker-windows-privilege-escalation"]
---
...
Also load [SHELL_CHEATSHEET.md](references/SHELL_CHEATSHEET.md) when you need:
