---
name: hacker-dangling-markup-injection
description: "Dangling markup injection playbook. Use when HTML injection is possible but JavaScript execution is blocked (CSP, sanitizer strips event handlers, WAF blocks script tags) — exfiltrate CSRF tokens, session data, and page content by injecting unclosed HTML tags that capture subsequent page content."
metadata:
  hermes:
    tags: [web-clientside, "redteam", "offensive"]
    related_skills: ["hacker-clickjacking", "hacker-cors-cross-origin-misconfiguration", "hacker-csp-bypass-advanced", "hacker-dangling-markup-injection", "hacker-dns-rebinding-attacks", "hacker-open-redirect", "hacker-websocket-security", "hacker-csrf-cross-site-request-forgery", "hacker-api-auth-and-jwt-abuse"]
---
