---
name: hacker-sandbox-escape-techniques
description: "Sandbox escape playbook. Use when breaking out of Python sandbox, Lua sandbox, seccomp filter, chroot jail, container/Docker, browser sandbox, or namespace isolation to achieve unrestricted code execution or file access."
metadata:
  hermes:
    tags: [binary-pwn, "redteam", "offensive"]
    related_skills: ["hacker-anti-debugging-techniques", "hacker-binary-protection-bypass", "hacker-browser-exploitation-v8", "hacker-code-obfuscation-deobfuscation", "hacker-format-string-exploitation", "hacker-ghost-bits-cast-attack", "hacker-heap-exploitation", "hacker-kernel-exploitation", "hacker-macos-process-injection", "hacker-sandbox-escape-techniques", "hacker-stack-overflow-and-rop", "hacker-symbolic-execution-tools", "hacker-vm-and-bytecode-reverse"]
---
...
- [PYTHON_SANDBOX_ESCAPE.md](references/PYTHON_SANDBOX_ESCAPE.md) — Full pyjail methodology: `__builtins__` recovery, keyword bypass, AST bypass, pickle escape
- [SECCOMP_BYPASS.md](references/SECCOMP_BYPASS.md) — Architecture confusion, io_uring bypass, ptrace bypass, allowed syscall chaining
...
See [PYTHON_SANDBOX_ESCAPE.md](references/PYTHON_SANDBOX_ESCAPE.md) for full methodology.
