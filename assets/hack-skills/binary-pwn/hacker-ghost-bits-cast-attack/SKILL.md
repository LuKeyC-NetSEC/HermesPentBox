---
name: hacker-ghost-bits-cast-attack
...
Load [PAYLOAD_COOKBOOK.md](references/PAYLOAD_COOKBOOK.md) when you need:
...
See [PAYLOAD_COOKBOOK.md](references/PAYLOAD_COOKBOOK.md) for affected-version
