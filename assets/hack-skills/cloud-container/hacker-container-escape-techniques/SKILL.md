---
name: hacker-container-escape-techniques
...
metadata:
  hermes:
    tags: [cloud-container, "redteam", "offensive"]
    related_skills: ["hacker-container-escape-techniques", "hacker-kubernetes-pentesting", "hacker-kernel-exploitation"]
---
...
Also load [DOCKER_ESCAPE_CHAINS.md](references/DOCKER_ESCAPE_CHAINS.md) when you need:
