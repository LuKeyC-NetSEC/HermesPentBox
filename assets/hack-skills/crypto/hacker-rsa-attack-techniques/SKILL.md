---
name: hacker-rsa-attack-techniques
description: "RSA attack playbook for CTF and real-world cryptanalysis. Use when given RSA parameters (n, e, c) and need to recover plaintext by exploiting weak keys, small exponents, shared factors, or padding oracles."
metadata:
  hermes:
    tags: [crypto, "redteam", "offensive"]
    related_skills: ["hacker-classical-cipher-analysis", "hacker-lattice-crypto-attacks", "hacker-rsa-attack-techniques", "hacker-symmetric-cipher-attacks"]
---
...
Also load [RSA_ATTACK_CATALOG.md](references/RSA_ATTACK_CATALOG.md) when you need:
