---
name: hacker-unauthorized-access-common-services
description: "Unauthorized access playbook for common exposed services. Use when Redis, Rsync, PHP-FPM, AJP/Ghostcat, Hadoop YARN, H2 Console, or similar management interfaces are exposed without authentication."
metadata:
  hermes:
    tags: [auth-access, "redteam", "offensive"]
    related_skills: ["hacker-api-auth-and-jwt-abuse", "hacker-api-authorization-and-bola", "hacker-api-sec", "hacker-auth-sec", "hacker-authbypass-authentication-flaws", "hacker-idor-broken-object-authorization", "hacker-jwt-oauth-token-attacks", "hacker-oauth-oidc-misconfiguration", "hacker-saml-sso-assertion-attacks", "hacker-unauthorized-access-common-services"]
---
...
Also load [PORT_SERVICE_MATRIX.md](references/PORT_SERVICE_MATRIX.md) when you need:
