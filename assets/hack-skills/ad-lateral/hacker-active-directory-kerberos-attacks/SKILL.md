---
name: hacker-active-directory-kerberos-attacks
...
metadata:
  hermes:
    ...
    related_skills: ["hacker-active-directory-acl-abuse", "hacker-active-directory-certificate-services", "hacker-active-directory-kerberos-attacks", "hacker-ntlm-relay-coercion", "hacker-linux-lateral-movement"]
---
...
Also load [KERBEROS_ATTACK_CHAINS.md](references/KERBEROS_ATTACK_CHAINS.md) when you need:
